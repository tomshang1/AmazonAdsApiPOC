...
public class ListTargetApi {
    public static TargetSuccessResponse listTarget(
            final TargetsApi targetsApi,
            final QueryTargetRequest listRequestContent,
            final Map<String, String> authMap)
            throws IOException, InterruptedException, ApiException {
        final TargetSuccessResponse listResponseContent;
        try {
            ...
            listResponseContent = targetsApi.queryTarget(
                    authMap.get(CLIENT_ID_HEADER_NAME), "", authMap.get(PROFILE_ID_HEADER_NAME), listRequestContent);
